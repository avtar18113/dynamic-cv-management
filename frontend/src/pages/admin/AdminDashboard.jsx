        ...
        <main className="flex-1 p-6 mt-16 overflow-y-auto">
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Manage projects, users, and CV submissions from this dashboard.
            </p>
          </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-2xl font-semibold text-gray-800">1,234</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-2xl font-semibold text-gray-800">24</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-2xl font-semibold text-gray-800">56</p>
                </div>
